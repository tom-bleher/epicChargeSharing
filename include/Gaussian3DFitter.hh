...
public:
    ...
    enum FitType {
        ...
        OUTLIER_CLEANED = 1  // Fit with outlier detection and removal
    };
    ...
    struct FitResults {
        ...
        G4int n_outliers_removed;  // Number of outliers removed
...
private:
    ...
    static const G4double fOutlierThreshold;   // Z-score threshold for outlier removal
